...
Хотя код требует улучшениий.
Писал с помощью ИИ как набросок.
И сценарий довольно специфичный.
При использовании FastAPI такое вряд ли потребуется.
Контекст - синхронная монолиитная Джанго и долгие запросы от стороннего сервиса.
